...
\logo{\includegraphics[height=0.5cm]{poziom-en.pdf}}
...
\item Webpages:
     \begin{itemize}
     \item My home page: 
     \href{http://www.im.pwr.wroc.pl/~pziel/}{\structure{http://www.im.pwr.wroc.pl/ \~{}pziel/}}
      \end{itemize} 
\item \alert{The GNU Linear Programming Kit (GLPK)}: \texttt{glpsol} solver plus 
   the \structure{GNU MathProg modeling language}
